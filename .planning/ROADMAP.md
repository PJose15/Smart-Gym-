...
- [ ] 01-05-PLAN.md — (onboard)/ route group, register API with rollback, signup + verify-email pages [wave 2]
- [ ] 01-06-PLAN.md — Subscribe page: session handshake, live-price tier picker, abandonment resume [wave 3]
- [ ] 01-07-PLAN.md — First-machine wizard with QR PDF download [wave 3]
...
|-------|----------------|--------|-----------|
| 1. Gym Owner Self-Serve Onboarding | 0/9 | Planned (9 plans, 4 waves) | - |
