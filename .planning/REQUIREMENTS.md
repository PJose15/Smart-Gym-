...
- [x] **CHAL-01**: Member can browse active and completed gym challenges on mobile
...
- [x] **CHAL-03**: Member sees their own progress within a joined challenge
...
- [x] **PROG-03**: Member can start today's workout or drill into an exercise from the program view
...
- [x] **AGENT-01**: Agent triggers actually reach the UptimizeAI engine (not just logged)
...
- [x] **NOTIF-01**: All pushes flow through one dispatcher that enforces user preferences
...
- [x] **NOTIF-02**: The 24+ trigger types are wired from their event sources
